 ...
 * {@link #setRawValue RawValue}, the properties are completely orthogonal, that
 * is: each property is independant of the others. This means you have enough
 * rope here to hang yourself, and it's very easy to create malformed HTML.
 * Where it's obvious, warnings and notes have been provided in the setters
 * javadocs, but it is up to you -- the programmer -- to ensure that the
 ...
 * using quotation marks even when it is possible to eliminate them.<p>
...
public class Attribute implements Serializable {
    ...
    private static final long serialVersionUID = 1544053027891660987L;
     ...
     * The equals sign.
     * This will be <code>null</code> if the attribute is a stand-alone
     * attribute.
     */
     ...
     * <code>null</code>, and calls {@link #setRawValue} to get the correct
     * quoting if <code>quote</code> is zero.
     * 
     * @param name The name of this attribute.
     * @param value The value of this attribute.
     * @param quote The quote around the value of this attribute.
     ...
     *            whitespace. To set a real value use
     ...
     * The part before the equals sign, or the contents of the stand-alone
     * attribute.
     * 
     ...
     * Set the part before the equals sign, or the contents of the stand-alone
     * attribute.
     ...
     * <em>WARNING:</em> Setting this property to other than an equals sign or
     * <code>null</code> will result in malformed HTML. In the case of a
     ...
     * If the value is pure whitespace, assign it 'as is' and reset the quote
     * character. If not, check for leading and trailing double or single
     * quotes, and if found use this as the quote character and the inner
     * contents of <code>value</code> as the real value.
     * Otherwise, examine the string to determine if quotes are needed and an
     * appropriate quote character if so. This may involve changing double
     * quotes within the string to character references.
     * 
     * @param value The new value.
     * @see #getRawValue
     ...
     * Suitable for insertion into a tag, the output is one of the forms:
     * <code>
     * <pre>
     * value
     * name
