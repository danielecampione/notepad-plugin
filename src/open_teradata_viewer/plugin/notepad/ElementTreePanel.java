 ...
 * will result in reseting the selection of the JTextComponent.
 * This also becomes a CaretListener to know when the selection has changed in
 * the text to update the selected item in the tree.
 *
 * @author D. Campione
 * 
 */
public class ElementTreePanel extends JPanel
    ...
    private static final long serialVersionUID = -8037423745187871644L;

    /** Tree showing the documents element structure. */
    protected JTree tree;

    /** Text component showing elements for. */
    ...
    public ElementTreePanel(JTextComponent editor) {
        ...
        tree = new JTree(treeModel) {
            ...
            private static final long serialVersionUID = -5381319522173996327L;
        ...
        tree.setCellRenderer(new DefaultTreeCellRenderer() {
            ...
            private static final long serialVersionUID = 6759049447392245905L;
    ...
    public void caretUpdate(CaretEvent e) {
        if (!updatingSelection) {
            ...
            // Build an array of all the paths to all the character elements in
            // the selection.
     ...
     * root a fake node has be created. This class creates a fake node as the
     * root with the children being the root elements of the Document
     * (getRootElements).
    ...
    public static class ElementTreeModel extends DefaultTreeModel {
        ...
        private static final long serialVersionUID = 5422922343617294406L;
         ...
         * node is a leaf or if it has no children.
         * <I>parent</I> must be a node previously obtained from this data
         * source.
         *
         * @param   parent  a node in the tree, obtained from this data source
